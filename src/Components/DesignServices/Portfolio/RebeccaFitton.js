            ...
            <div className="flex column bg-light-pink">
                ...
                <div className="flex al-center column">
                    <div className="portfolio-desc">
                        ...
                        <p><a href='https://www.instagram.com/_rebecca.fitton' target="_blank">@_rebecca.fitton</a></p>
                        <p><a href="https://rebeccafittonprojects.com" target="_blank">https://rebeccafittonprojects.com</a></p> 
                    </div>     
                </div>
            </div>
        </>
